            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="flex items-center">
                  ...
                  <span className="ml-3 text-xl font-bold text-gray-900">BadmintonPro</span>
                </div>
              </div>
            </div>
            {user && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              Streamline your badminton club operations with intelligent matchmaking, 
              real-time analytics, and seamless session management.
            </p>
              ...
              <div className="space-y-6">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 max-w-2xl mx-auto border border-white/20">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button
                      onClick={signOut}
                      className="inline-flex items-center px-8 py-4 border border-gray-300 text-base font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Smart Matchmaking</h3>
              <p className="text-gray-600">AI-powered player pairing based on skill levels and preferences for balanced, competitive games.</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600">Track player performance, court utilization, and session statistics with live dashboards.</p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600">Efficiently organize recurring sessions, handle check-ins, and manage court assignments.</p>
            </div>
          </div>
        </div>
      </div>
